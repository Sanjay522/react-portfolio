...
const LetsWorkTogether: React.FC = () => {
    return (
        <div className='sm:w-[70vw] sm:flex flex flex-col sm:justify-center sm:m-auto relative items-center mt-10 '>
            <div className='sm:my-10 my-5'>
                <h1 className='sm:text-9xl text-center text-5xl'>LET'S WORK</h1>
                <h1 className='sm:text-9xl text-center text-5xl'> TOGETHER</h1>
            </div>
            <button className='my-10 border-2 rounded-full px-5 py-1  w-35'>CONTACT NOW</button>
  ...
  <div className="hidden sm:block text-center">
    <p>FRONT-END DEVELOPER</p>
            ...
            <div className='text-2xl text-center sm:my-10  my-8'>
            ...
            <div className='text-2xl sm:flex sm:flex-row flex flex-col  justify-center items-center'>
